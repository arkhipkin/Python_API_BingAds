...
# Required
DEVELOPER_TOKEN = 'you token here'	#'BBD37VB98' # Universal token for sandbox
ENVIRONMENT = 'production'	#	'sandbox' # If you use 'production' then you must also update the developer token.
